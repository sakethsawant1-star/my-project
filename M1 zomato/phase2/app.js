                            ...
                            <div class="p-6 flex-grow flex flex-col justify-between ${isFirst ? 'md:w-1/2' : ''}">
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <div class="flex items-center gap-1 bg-green-100 text-green-800 px-2 py-1 rounded text-sm font-bold">
                                ...
                                <a href="https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(rec.name + ' ' + (rec.location || ''))}" target="_blank" class="w-full bg-[#b7122a] text-white text-center font-semibold py-3 rounded-lg hover:bg-[#92001c] transition-colors shadow-md active:scale-95 no-underline">Get Directions</a>
                            </div>
                        </article>
                    `;
